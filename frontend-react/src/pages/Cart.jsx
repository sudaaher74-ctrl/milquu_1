    ...
    <div className="min-h-screen bg-gradient-to-b from-[#FDFBF7] to-white pt-28 pb-12 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-4 sm:px-6 relative z-10">
        ...
        {cartItems.length === 0 ? (
          ...
          <div className="bg-white/90 backdrop-blur-2xl p-6 sm:p-8 rounded-[24px] border border-white/60 shadow-xl">
            <h1 className="text-2xl font-serif font-bold text-milquu-dark mb-6">Checkout</h1>
            ...
            {/* Calculations */}
            <div className="space-y-2 mb-6 font-sans text-sm bg-gray-50/50 p-4 rounded-2xl">
            ...
            {/* Checkout Form (Always visible now) */}
