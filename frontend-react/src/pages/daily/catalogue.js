...
export const DEFAULT_POPULAR_PRODUCTS = [
  {
    ...
    key: 'prod-buffalo-milk',
    name: 'Premium Buffalo Milk',
    unit: '1 Litre',
    price: 75,
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/buffalomilk.png',
    cat: 'milk',
  },
  {
    id: 'prod-a2-cow-milk',
    key: 'prod-a2-cow-milk',
    name: 'A2 Cow Milk',
    unit: '1 Litre',
    price: 90,
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/A2milk.png',
    cat: 'milk',
  },
  {
    id: 'prod-cow-ghee',
