...
export const PRESENTATION = {
  ...
  'Cow Milk (Pouch)': {
    short: 'Cow Milk (Pouch)',
    kicker: 'Daily pouch',
    meta: 'Light, 4.0% fat · pouch',
    desc: 'Farm fresh cow milk in convenient pouch packaging, delivered daily to your doorstep.',
    sub: 'Fresh cow milk',
    tags: ['4.0% fat', 'No preservatives', 'Fresh pouch'],
    spec: [['Fat', '4.0%'], ['SNF', '8.5%']],
  },
  'Buffalo Milk (Pouch)': {
    short: 'Buffalo Milk (Pouch)',
    kicker: 'Thick & creamy',
    meta: 'Full cream, 6.5% fat · pouch',
    desc: 'Rich, full cream buffalo milk in fresh pouch packaging for morning chai and curd.',
    sub: 'Murrah buffalo',
    tags: ['6.5% fat', 'No preservatives', 'Fresh pouch'],
    spec: [['Fat', '6.5%'], ['SNF', '9.2%']],
  },
};
 ...
 * standing-order rate. Falls back to `price` if no explicit `planPrice` is configured.
 */
export const decorate = (product) => {
  ...
  return {
    ...
    unit: product.unit,
    price: product.price,
    plan: product.planPrice ?? product.price,
    stock: Number.isNaN(stockLevel) ? 0 : stockLevel,
    isOutOfStock,
...
export const DEFAULT_POPULAR_PRODUCTS = [
  {
    id: '6a192d24e2f5374ee6c89e32',
    key: '6a192d24e2f5374ee6c89e32',
  ...
  {
    id: '6a192d24e2f5374ee6c89e31',
    key: '6a192d24e2f5374ee6c89e31',
    name: 'A2 Cow Milk',
    unit: '1 Litre',
    price: 90,
    plan: 90,
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/A2milk.webp',
    cat: 'milk',
  },
  {
    id: '6a192d24e2f5374ee6c89e33',
    key: '6a192d24e2f5374ee6c89e33',
    name: 'Pure Cow Milk',
    unit: '1 Litre',
    price: 64,
    plan: 64,
  ...
  {
    id: '6a1e90f5db96db81aa2125d3',
    key: '6a1e90f5db96db81aa2125d3',
    name: 'Cow Milk (Pouch)',
    unit: '1 Litre',
    price: 58,
    plan: 58,
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/cowmilkplasticbag.png',
    cat: 'milk',
  },
  {
    id: '6a1e90f5db96db81aa2125d4',
    key: '6a1e90f5db96db81aa2125d4',
    ...
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/buffalomilkplasticbag.png',
    cat: 'milk',
  },
  {
    id: '6a192d24e2f5374ee6c89e38',
    key: '6a192d24e2f5374ee6c89e38',
    name: 'Pure Cow Ghee',
    unit: '1 Litre',
    price: 450,
    stock: 0,
    isOutOfStock: true,
    img: '/img/products/cowghee.webp',
    cat: 'ghee',
  },
  {
    id: '6a192d24e2f5374ee6c89e37',
    key: '6a192d24e2f5374ee6c89e37',
    name: 'A2 Cow Ghee',
    unit: '500g',
    price: 850,
    stock: 0,
  ...
  {
    id: '6a192d24e2f5374ee6c89e34',
    key: '6a192d24e2f5374ee6c89e34',
    name: 'Fresh Dahi',
    unit: '500g',
    price: 60,
    stock: 0,
  ...
  {
    id: '6a192d24e2f5374ee6c89e36',
    key: '6a192d24e2f5374ee6c89e36',
    name: 'Soft Paneer',
    unit: '1 Litre',
    price: 90,
    stock: 0,
  ...
  {
    id: '6a192d24e2f5374ee6c89e35',
    key: '6a192d24e2f5374ee6c89e35',
    name: 'Sweet Lassi',
    unit: '1 Litre',
    price: 25,
    stock: 0,
...
export const DEFAULT_MILK_PLANS = [
  {
    id: 'cow-milk-plan',
    productId: '6a192d24e2f5374ee6c89e33',
    name: 'Cow Milk Plan',
  ...
  {
    id: 'buffalo-milk-plan',
    productId: '6a192d24e2f5374ee6c89e32',
    name: 'Buffalo Milk Plan',
  ...
  {
    id: 'a2-cow-milk-plan',
    productId: '6a192d24e2f5374ee6c89e31',
    name: 'A2 Cow Milk Plan',
    subtitle: 'Easily digestible',
    price: 90,
    unit: 'Litre',
    popular: false,
    features: [
  ...
  {
    id: 'cow-milk-pouch-plan',
    productId: '6a1e90f5db96db81aa2125d3',
    name: 'Cow Milk (Pouch) Plan',
    subtitle: 'Fresh & economical',
    price: 58,
    unit: 'Litre',
    popular: false,
    features: [
  ...
  {
    id: 'buffalo-milk-pouch-plan',
    productId: '6a1e90f5db96db81aa2125d4',
    name: 'Buffalo Milk (Pouch) Plan',
    subtitle: 'Rich curd & tea',
    price: 72,
    unit: 'Litre',
    popular: false,
    features: [
