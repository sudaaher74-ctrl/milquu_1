...
const FloatingWhatsApp = () => {
  ...
  return (
    ...
    >
      ...
      {/* Tooltip */}
      <div className="absolute right-16 top-1/2 -translate-y-1/2 px-3 py-1.5 bg-white text-gray-800 text-sm font-semibold rounded shadow opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none whitespace-nowrap">
        Chat with us
      </div>
    </a>
  );
